...
rpn_layers = net.rpn_layer(shared_layers, num_anchors)

classifier = net.classifier(feature_map_input, roi_input, C.num_rois, nb_classes=len(class_mapping), trainable=True)
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	R = utils.rpn_to_roi(Y1, Y2, C, K.image_dim_ordering(), overlap_thresh=0.7)
